    ...
    public void verifyClientHasAccount(){
        if (super.user.getAccounts().size() == 0){
            ...
            if (super.user.getClient() instanceof NaturalPerson){
                ...
                new CreateAccount(super.user).createAccountNaturalPerson();
                // mostrar as contas ativas
                    // abrir uma janela de comandos para acessar qual conta
                        // abrir mensagem de acoes possiveis
                            // receber o input
